...
# ============================================================
# 1. BULLETPROOF CREDENTIALS & CONSTANTS (SELF-CONTAINED)
# ============================================================
...
# ============================================================
# 3. SIDEBAR UTILITIES (1:1 EXACT PHOTO-TO-PDF & VERBATIM OCR)
# ============================================================
...
# TAB 1: PURE DIRECT CHAT (DIRECT ANSWERS, ZERO ASSUMPTIONS)
with tab_chat:
    for m in st.session_state.messages:
        with st.chat_message(m["role"], avatar="👤" if m["role"] == "user" else "🤖"):
            st.markdown(m["content"])

    user_query = st.chat_input("Ask any doubt or question (History, Science, Maths, Current Affairs, Coding)...")
    if user_query:

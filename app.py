...
# ============================================================
# 3. SIDEBAR UTILITIES (1:1 EXACT PHOTO-TO-PDF & OCR)
# ============================================================
...
# ============================================================
# 4. REASONING ENGINE (GROQ + GEMINI FAILOVER)
# ============================================================
def ask_aetheris(system_instruction: str, user_prompt: str, max_tokens=2500) -> str:
    ...
    if GROQ_API_KEY and Groq:
        ...
        log_errors.append("Groq: Key missing or library not loaded")
    ...
    if GEMINI_API_KEY and REQUESTS_OK:
        ...
        log_errors.append("Gemini: Key missing or requests library unavailable")
        ...
        with st.chat_message("assistant", avatar="🤖"):
            with st.spinner("Answering..."):
                sys_instruction = (
                    ...
                    "Do NOT assume or force any RTI or predefined template unless explicitly asked. "
                    "Answer doubts, concepts, or questions clearly in Hindi, Hinglish, or English."
                )
